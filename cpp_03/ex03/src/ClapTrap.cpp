...
ClapTrap::ClapTrap(const ClapTrap& other): name(other.name), hitPoint(other.hitPoint), e(other.e), AttackDamage(other.AttackDamage)
{
...
void	ClapTrap::attack(const std::string& target)
{
	...
	{
		this->e--;
		std::cout << "\033[1;33m" << this->name << " attack " << target << ", causing " << this->AttackDamage << " points of damage." << "\033[0m" << std::endl;
	}
	else if (this->e <= 0)
